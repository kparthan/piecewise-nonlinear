...
\begin{figure}[!htb]
  \centering
    ...
    {
      \centering
        \includegraphics[width=0.45\textwidth]{fig/histograms.boxplot.parts.234.score0.eps}
        \label{fig:score0}
    }
    \hspace{0.5cm}
    \subfigure[Avg. score]
    {
        \centering
        \includegraphics[width=0.45\textwidth]{fig/histograms.boxplot.parts.234.avg.score0.eps}
        \label{fig:avg_score0}
    }
    \caption{Using the difference in global histogram values (375 pivots): $\sum_{r} H_a(r) - H_b(r)$}
...
\begin{figure}[!htb]
  \centering
    ...
    {
      \centering
        \includegraphics[width=0.45\textwidth]{fig/histograms.boxplot.parts.234.score1.eps}
        \label{fig:score1}
    }
    \hspace{0.5cm}
    \subfigure[Avg. score]
    {
        \centering
        \includegraphics[width=0.45\textwidth]{fig/histograms.boxplot.parts.234.avg.score1.eps}
        \label{fig:avg_score1}
    }
    \caption{Using the difference in normalized global histogram values (375 pivots): $\sum_{r} \frac{H_a(r)}{\Delta l_1} - \frac{H_b(r)}{\Delta l_2}$}
...
\begin{figure}[!htb]
  \centering
    ...
    \caption{Comparison of normalized global histograms for classes A and B (over 100 pivots)}
...
\begin{figure}[!htb]
  \centering
    ...
    \caption{Comparison of normalized global histograms for class C (over 100 pivots)}
