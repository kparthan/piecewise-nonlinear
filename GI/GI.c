...
This program may as of May 11'th 2011 be dawnloades and used under the GNU general Public License version 3
...
#define CylinderTransform 0 /*The Cylindertransform is normalized such 
